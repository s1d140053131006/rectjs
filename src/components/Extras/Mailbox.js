                ...
                <div className="row">
                    <div className="col-xl-3 col-lg-4">
                        <div className="d-flex mb-2">
                            <a className="btn btn-purple btn-sm mb-compose-button" href="">
                                <em className="fa fa-pencil"></em>
                                <span>Compose</span>
                            </a>
                            <button className="btn btn-sm btn-secondary mb-toggle-button ml-auto" type="button" data-toggle="collapse" data-target=".mb-boxes">
                                    ...
                                    <ul className="nav nav-pills flex-column">
                                        ...
                                        <li className="nav-item active">
                                            <a className="nav-link d-flex align-items-center" href="">
                                                <em className="fa fa-fw fa-lg fa-inbox mr-2"></em>
                                                <span>Inbox</span>
                                        ...
                                        <li className="nav-item">
                                            <a className="nav-link d-flex align-items-center" href="">
                                                <em className="fa fa-fw fa-lg fa-star mr-2"></em>
                                                <span>Starred</span>
                                        ...
                                        <li className="nav-item">
                                            <a className="nav-link d-flex align-items-center" href="">
                                                <em className="fa fa-fw fa-lg fa-paper-plane-o mr-2"></em>
                                                <span>Sent</span>
                                        ...
                                        <li className="nav-item">
                                            <a className="nav-link d-flex align-items-center" href="">
                                                <em className="fa fa-fw fa-lg fa-edit mr-2"></em>
                                                <span>Draft</span>
                                        ...
                                        <li>
                                            <a className="nav-link d-flex align-items-center" href="">
                                                <em className="fa fa-fw fa-lg fa-trash mr-2"></em>
                                                <span>Trash</span>
                                                <span className="ml-auto badge badge-green">0</span>
                                            </a>
                                        </li>
                                        ...
                                        <li className="nav-item">
                                            <a className="py-1 nav-link" href="">
