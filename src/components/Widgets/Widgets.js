        ...
        return (
            <ContentWrapper>
                        ...
                        <div className="card">
                            ...
                            <div className="d-flex">
                                <div className="w-50 br px-3">
                                    <div className="d-flex align-items-center justify-content-center">
                                        <em className="fa fa-code-fork fa-2x text-inverse"></em>
                                        <div className="ml-auto">
                                            <div className="card-body text-right">
                        ...
                        <div className="card">
                            ...
                            <div className="card-body bg-inverse">
                                <div className="d-flex justify-content-center align-items-center">
                                    ...
                                    <div className="ml-auto">
                                        <div className="d-flex">
                                            <em className="fa fa-map-marker fa-3x mr-3"></em>
                ...
                <div className="card card-transparent">
                    <Nav tabs justified>
                        <NavItem>
                            <NavLink href="#settingsapp" className={ this.state.activeTab === 'tasks' ? 'active':'' }
                                onClick={() => { this.toggleTab('tasks'); }}
                            >
                                <em className="fa fa-clock-o fa-fw"></em>Tasks card
                            </NavLink>
                        </NavItem>
                        <NavItem>
                            <NavLink href="#chatapp" className={ this.state.activeTab === 'trans' ? 'active':'' }
                                onClick={() => { this.toggleTab('trans'); }}
                            >
                                <em className="fa fa-money fa-fw"></em>Transactions card
                            </NavLink>
                        </NavItem>
                    </Nav>
                        ...
                        <TabPane tabId="tasks">
                            ...
                            <div className="list-group mb0">
                                <div className="list-group-item bt0">
                                    ...
                                    <em className="fa fa-fw fa-calendar mr-2"></em>Calendar updated
                                </div>
                                <div className="list-group-item">
                                    <span className="badge badge-purple float-right">4 minutes ago</span>
                                    <em className="fa fa-fw fa-comment mr-2"></em>Commented on a post
                                </div>
                                <div className="list-group-item">
                                    <span className="badge badge-purple float-right">23 minutes ago</span>
                                    <em className="fa fa-fw fa-truck mr-2"></em>Order 392 shipped
                                </div>
                                <div className="list-group-item">
                                    <span className="badge badge-purple float-right">46 minutes ago</span>
                                    <em className="fa fa-fw fa-money mr-2"></em>Invoice 653 has been paid
                                </div>
                                <div className="list-group-item">
                                    <span className="badge badge-purple float-right">1 hour ago</span>
                                    <em className="fa fa-fw fa-user mr-2"></em>A new user has been added
                                </div>
                                <div className="list-group-item">
                                    <span className="badge badge-purple float-right">2 hours ago</span>
                                    <em className="fa fa-fw fa-check mr-2"></em>Completed task: "pick up dry cleaning"
                                </div>
                                <div className="list-group-item">
                                    <span className="badge badge-purple float-right">yesterday</span>
                                    <em className="fa fa-fw fa-globe mr-2"></em>Saved the world
                                </div>
                                <div className="list-group-item">
                                    <span className="badge badge-purple float-right">two days ago</span>
                                    <em className="fa fa-fw fa-check mr-2"></em>Completed task: "fix error on sales page"
                                </div>
                                <div className="list-group-item">
                                    <span className="badge badge-purple float-right">two days ago</span>
                                    <em className="fa fa-fw fa-check mr-2"></em>Completed task: "fix error on sales page"
