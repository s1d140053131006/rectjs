                            ...
                            <div className="card b">
                                <div className="card-body text-center">
                                    <a className="link-unstyled text-primary" href="">
                                        <em className="fa fa-5x fa-television mb-3"></em>
                                        <br/>
                            ...
                            <div className="card b">
                                <div className="card-body text-center">
                                    <a className="link-unstyled text-info" href="">
                                        <em className="fa fa-5x fa-object-group mb-3"></em>
                                        <br/>
                            ...
                            <div className="card b">
                                <div className="card-body text-center">
                                    <a className="link-unstyled text-purple" href="">
                                        <em className="fa fa-5x fa-cubes mb-3"></em>
                                        <br/>
                            ...
                            <div className="card b">
                                <div className="card-body text-center">
                                    <a className="link-unstyled text-warning" href="">
                                        <em className="fa fa-5x fa-diamond mb-3"></em>
                                        <br/>
                            ...
                            <div className="card b">
                                <div className="card-body text-center">
                                    <a className="link-unstyled text-danger" href="">
                                        <em className="fa fa-5x fa-building-o mb-3"></em>
                                        <br/>
                            ...
                            <div className="card b">
                                <div className="card-body text-center">
                                    <a className="link-unstyled text-success" href="">
                                        <em className="fa fa-5x fa-calendar-check-o mb-3"></em>
                                        <br/>
                    ...
                    <Row>
                            ...
                            <div className="card b">
                                <div className="card-body text-center">
                                    <a className="link-unstyled text-dark" href="">
                                        <em className="fa fa-5x fa-recycle mb-3"></em>
                                        <br/>
                        ...
                        <Col lg="4">
                            <div className="card b">
                                <div className="card-body text-center">
                                    <a className="link-unstyled text-dark" href="">
                                        <em className="fa fa-5x fa-street-view mb-3"></em>
                                        <br/>
