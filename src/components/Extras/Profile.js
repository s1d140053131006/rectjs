                                        ...
                                        <div className="popover left">
                                            ...
                                            <div className="popover-body">
                                                ...
                                                <a className="mb-2 text-info d-flex align-items-center link-unstyled" href="">
                                                    <span>
                                                        <em className="fa fa-file-o fa-fw mr-2 text-inverse"></em>
                            ...
                            <div className="card card-default">
                                <ListGroup>
                                    ...
                                    <ListGroupItem className="d-flex">
                                        ...
                                        <em className="ml-auto fa fa-map-marker fa-lg fa-fw text-muted mt-2"></em>
                                    </ListGroupItem>
                                    <ListGroupItem className="d-flex">
                                        <span>
                                            <h4>400</h4>
                                    ...
                                    <ListGroupItem className="d-flex">
                                        ...
                                        <em className="ml-auto fa fa-twitter fa-lg fa-fw text-muted mt-2"></em>
                                    </ListGroupItem>
                                </ListGroup>
                            </div>
                        </Col>
