                        ...
                        <div className="card b">
                            <div className="card-body bb">
                                ...
                                <div className="d-flex align-items-center mb-2">
                                    ...
                                    <div className="ml-auto col wd-xxs text-right">
                                ...
                                <div className="row text-center">
                                    ...
                                    <div className="col-3 col-lg-6 col-xl-3">
                                     <Sparkline values="30,70"
                                        ...
                                        className="sparkline"/>                                        <p className="mt-3">Assigned</p>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <table className="table w-100">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>01/01/2016</td>
                                                <td>
                                                    <div className="circle circle-lg bg-warning" data-toggle="tooltip" data-title="normal"></div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>01/05/2016</td>
                                                <td>
                                                    <div className="circle circle-lg" data-toggle="tooltip" data-title="low"></div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>01/01/2015</td>
                                                <td>
                                                    <div className="circle circle-lg bg-danger" data-toggle="tooltip" data-title="high"></div>
                                                </td>
                                                <td>
